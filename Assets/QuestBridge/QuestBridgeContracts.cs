...
namespace QuestBridge
{
    ...
    [Serializable] public class ContentIssue { public string field,code,message; }
    [Serializable] public class ContentReview { public string status,aiMode,message; public ContentIssue[] issues; }
    [Serializable] public class ScorePreview { public int readiness; public string readinessLevel; public ScoreRow[] scoreBreakdown; public string[] missingFields; public ContentReview validation; }
    [Serializable] public class TaskRecord
    {
        ...
        public string[] confirmedFields, missingFields, teamIds; public ScoreRow[] scoreBreakdown; public bool demo; public ContentReview validation;
    }
